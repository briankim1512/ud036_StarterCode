...
# Movie database for the website in format:
# Title, story description, poster image, and trailer video
prisoners = media.Movie("Prisoners",
                        "A daughter goes missing and two people use their own"
                        " means to find her",
...
noCountryForOldMen = media.Movie("No Country For Old Men",
                                 "A man finds a stash of money, but is shortly"
                                 " pursued by an unstoppable force",
                                 "https://images-na.ssl-images-amazon.com"
                                 "/images/M/MV5BMjA5Njk3MjM4OV5BMl5BanBnXkFtZT"
                                 "cwMTc5MTE1MQ@@._V1_.jpg",
                                 "https://www.youtube.com/watch?v=38A__WT3-o0")

sicario = media.Movie("Sicario",
                      "A FBI agent is recruited into a shady team of "
                      "operatives who's methods are not textbook",
                      "https://images-na.ssl-images-amazon.com/images/M/MV5BMj"
                      "A5NjM3NTk1M15BMl5BanBnXkFtZTgwMzg1MzU2NjE@."
